...
const AboutPage = () => {
  return (
    <div className="min-h-screen py-4 md:py-8 px-4 md:px-0 overflow-hidden">
          ...
          <div className="px-6 md:px-10 pb-8 flex flex-col md:flex-row items-center md:items-end -mt-20 md:-mt-24 gap-6 relative z-10">
            ...
            >
              ...
              >
                ...
                {/* Foreground Image (Graduate - Fades Out) */}
                <motion.img 
                  src={profile} 
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          >
            ...
            <div className="relative pl-6 border-l-2 border-green-500/30">
              <div className="absolute w-3 h-3 bg-green-500 rounded-full -left-[7px] top-1 shadow-lg shadow-green-500/50"></div>
          ...
          <motion.section 
            ...
            viewport={{ once: true }}
            className="bg-slate-900 dark:bg-green-600 p-8 rounded-[2rem] text-white shadow-2xl overflow-hidden relative"
          >
