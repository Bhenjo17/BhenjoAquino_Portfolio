...
import { Sun, Moon, User, LayoutDashboard, Briefcase, PenTool, Menu, X, Info, Award } from "lucide-react";
        ...
        <div className="flex flex-col h-full p-8">
          ...
          <div className="flex flex-col items-center mb-10 group">
            <div className="relative w-24 h-24 rounded-full overflow-hidden border-2 border-green-500">
              ...
              <img 
                src={cartoon} 
                className="w-full h-full object-cover opacity-100 group-hover:opacity-0 transition-opacity duration-300" 
                alt="Cartoon" 
              />
            </div>
